...
{
    public sealed class LuminosityD2DEffect : IBasicVideoEffect
    {
        [ComImport]
        ...
        private float? m_BrightnessWhitePointX = null;
        private float? m_BrightnessWhitePointY = null;
        private float? m_BrightnessBlackPointX = null;
        private float? m_BrightnessBlackPointY = null;
        ...
        public unsafe void ProcessFrame(ProcessVideoFrameContext context)
        {
            ...
            if (m_BrightnessWhitePointX == null)
                m_BrightnessWhitePointX = BrightnessWhitePointX;
            if (m_BrightnessWhitePointY == null)
                m_BrightnessWhitePointY = BrightnessWhitePointY;
            if (m_BrightnessBlackPointX == null)
                m_BrightnessBlackPointX = BrightnessBlackPointX;
            if (m_BrightnessBlackPointY == null)
                m_BrightnessBlackPointY = BrightnessBlackPointY;
            ...
            hr = m_pD2DDeviceContextEffect.CreateEffect(CLSID_D2D1Brightness, out pEffect);
            if (hr == HRESULT.S_OK)
            {
                pEffect.SetInput(0, inputBitmap);
                float[] aFloatArray = { (float)m_BrightnessWhitePointX, (float)m_BrightnessWhitePointY };
                SetEffectFloatArray(pEffect, (uint)D2D1_BRIGHTNESS_PROP.D2D1_BRIGHTNESS_PROP_WHITE_POINT, aFloatArray);
                float[] aFloatArray2 = { (float)m_BrightnessBlackPointX, (float)m_BrightnessBlackPointY };
        ...
        public float BrightnessWhitePointX
        {
            get
            {
                object val;
                if (configuration != null && configuration.TryGetValue("BrightnessWhitePointX", out val))
                {
                    return (float)val;
                }
                return 1.0f;
        ...
        public float BrightnessWhitePointY
        {
            get
            {
                object val;
                if (configuration != null && configuration.TryGetValue("BrightnessWhitePointY", out val))
                {
                    return (float)val;
                }
                return 1.0f;
        ...
        public float BrightnessBlackPointX
        {
            get
            {
                object val;
                if (configuration != null && configuration.TryGetValue("BrightnessBlackPointX", out val))
                {
                    return (float)val;
                }
                return 0.0f;
        ...
        public float BrightnessBlackPointY
        {
            get
            {
                object val;
                if (configuration != null && configuration.TryGetValue("BrightnessBlackPointY", out val))
                {
                    return (float)val;
                }
                return 0.0f;
